...
public class Signup3 extends JFrame implements ActionListener {
	...
	Signup3(String formno) {// this param Constructor because form no is taken by prev pages...
		this.formno = formno;
...
// here "" is used for  param constructor form no value
	...
	public void actionPerformed(ActionEvent ae) {
		...
		// random class to generate cardnumber
		...
		// if is used to check every condition
		// in else if if condition found other are not checked
		...
		// it is a risky task can throw an error so use try catch block

		try {

			// check which button from submit and cancel is clicked...(b1&b2)...

			if (ae.getSource() == b1) {

				// if nothing selected and clicked submit
				...
				if (atype.equals("")) {
					...
					// entries are filled and submit so connect with DB...

					Conn c1 = new Conn();

					// name should be same as in DB Table

					String q1 = "insert into signup3 values('" + formno + "','" + atype + "','" + cardNum + "','"
							+ pinNum + "','" + facility + "')";
					String q2 = "insert into Login values('" + formno + "','" + cardNum + "','" + pinNum + "')";
					c1.s.executeUpdate(q1);
					c1.s.executeUpdate(q2);

					// this shows your cardnumber and PIN Generated
